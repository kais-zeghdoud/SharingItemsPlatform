...
public class ItemCategory {
    ...
    @Produces(MediaType.TEXT_XML)
	    public List<Item> getItemsBrowser(/*@FormParam("itemCategory") String category*/) {
    		PlatformController pc = PlatformController.getInstance();
    		List<Item> items = new ArrayList<Item>();
    		String category = "book";
	    	switch (category) {
	    	case "book":
	    		items = pc.getItemsByCategory(Category.book);
	    		break;
	    	case "videoGame":
	    		items = pc.getItemsByCategory(Category.videoGame);
	    		break;
	    	case "musicCD":
	    		items = pc.getItemsByCategory(Category.musicCD);
	    		break;
	    	case "DVD":
	    		items = pc.getItemsByCategory(Category.DVD);
	    		break;
    	}
        return items;
    }
    ...
    public List<Item> get(@FormParam("itemCategory") String category) {
		PlatformController pc = PlatformController.getInstance();
		List<Item> items = new ArrayList<Item>();
    	switch (category) {
    	case "book":
    ...
    @Path("{rate}")
    public RateRessource getRate(@PathParam("item") String id) {
        return new RateRessource(uriInfo, request, id);
    }
