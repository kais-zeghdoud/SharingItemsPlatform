...
public class ItemsRessource {
    ...
    public void newItem(
    		...
    		/*,
            @FormParam("itemCategory") String cat,
    	...
    	String[] words = releaseDate.split(" ");
    	System.out.println(words[0]);
    	
    	Date date = new Date (Integer.parseInt(words[0]), 
    			Integer.parseInt(words[1]),
    	Integer.parseInt(words[2]));

    	Item item = new Item(id, category, itemName, author, date);*/
    	
        // set an attribut if it's missing
        /*if (description != null) {
            item.set(description);
        }*/
        ItemDao.instance.getModel().put(id, new Item (id, Category.musicCD, itemName, author, new Date (2001, 10, 10)));
